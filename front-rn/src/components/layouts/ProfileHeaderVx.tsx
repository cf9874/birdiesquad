...
export const ProfileHeaderVx = (props: { title: string; userSeq?: number; rotateMenu?: boolean, backHome?: typeof Screen[keyof typeof Screen] | undefined }) => {
                    ...
                    <Pressable
                        ...
                        onPress={() => {
                            if (isBanned) {
                                modalDispatch({
                                    open: true,
                                    children: <AlreadyBalemModalVx errorMsg="이미 이용제재된 계정입니다" />,
                                })
                            } else if (isBlamed) {
                                modalDispatch({
                                    open: true,
                                    children: <AlreadyBalemModalVx errorMsg="이미 신고한 계정입니다" />,
                                })
                            } else {
                                popUpDispatch({
                                    open: true,
...
export const AlreadyBalemModalVx = (props: IErrorMsg) => {
    const modalDispatch = useWrapDispatch(setModal)
