...
const useRadialSlider = (props: IRadialSliderHookProps) => {
    const {
        radius = 100,
        sliderWidth = 18,
    ...
    const lineHeight = getExtraSize(sliderWidth, thumbRadius, thumbBorderWidth) / 2 + thumbBorderWidth
...
export interface IRadialSliderHookProps {
    radius?: number
    sliderWidth?: number
